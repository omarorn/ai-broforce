class AudioService {
  ...
  private soundData: { [key: string]: string } = {
    ...
    double_jump: 'data:audio/wav;base64,UklGRiQAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YRAAAAAA/v/9/9L/xv/C/8n/y//S/9n/3f/i/+f/6v/w//P/9v/6//3//v/8/9T/wP+w/5j/j/+D/3z/bf9d/1r/W/9c/1//Yf9l/2r/c/96/4D/h/+M/5E=',
    wall_slide: 'data:audio/wav;base64,UklGRiIAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YRgAAAAA////gP9z/1L/QP8s/yH/Hf8n/zD/R/9g/3L/ff+E/4r/kv+b/5//q/+z/7r/w//G/8r/y//L/8r/x//D/7//t/+p/5z/lf+L/3//b/9R/zz/Lf8h/x7/IQ==',
    dig: 'data:audio/wav;base64,UklGRiIAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YRgAAAAA////gP9z/1L/QP8s/yH/Hf8n/zD/R/9g/3L/ff+E/4r/kv+b/5//q/+z/7r/w//G/8r/y//L/8r/x//D/7//t/+p/5z/lf+L/3//b/9R/zz/Lf8h/x7/IQ==',
